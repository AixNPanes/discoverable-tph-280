...
class Guage(Subscriber[GuageInfo]):
    ...
    def set_attributes(cls, name, value):
        ...
        super(Guage, cls).set_attributes(attributes={cls.value_name: cls._entity.value})
